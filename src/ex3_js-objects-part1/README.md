...
Написать функцию, которая принимает строку и объект, проверяет есть ли у переданного объекта свойство с данным именем, если такое свойство отсутствует, до добавляет его и устанавливает значение `'new'`. Функция должна возвращать модифицированную копию исходного объекта.
