...
Написать аналог опционального чейнинга (?. ES10) - функцию getProperty(object, propertyPath). Функция принимает 2 аргумента:
  - object: объект, из которого нужно получить свойство
  - propertyPath: строка, состоящая из цепочки ключей свойств, разделённых точкой - путь до свойства в объекте

Функция должна возвращать значение свойства по указанному пути, если оно есть, и undefined, если его нет.
