...
Удалить одно из созданных свойств. Данная функция не должна возвращать значение.
...
Написать функцию, которая принимает строку и объект, проверяет есть ли у переданного объекта свойство с данным именем, если такое свойство отсутствует, то добавляет его и устанавливает значение `'new'`. Функция должна возвращать модифицированную копию исходного объекта.
