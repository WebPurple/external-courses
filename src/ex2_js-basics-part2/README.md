...
Проверка на NaN обязательна!

## Задание 2

Написать функцию, которая будет пробегать по массиву и выводить в консоль каждый элемент массива и общее число элементов. Функция не должна ничего возвращать, но наличие `return undefined` обязательно!
